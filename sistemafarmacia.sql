...
SELECT * FROM produto
WHERE valorproduto BETWEEN 10.00 AND 30.00; /* pode ser um OR também que vai ser a mesma coisa */

--Select com maior que (>) /* ou menor que */
SELECT * FROM produto
...
--Select INNER JOIN ON /*forma nova de escrita */
SELECT * FROM farmacia
...
CALL listar_produtos_farmacia('12345678000199'); /* mostrando o resultado a depender do CNPJ que está cadastrado*/
...
BEGIN
    ...
    SELECT COUNT(*) /*contou quantas linhas tem cadastrado aquele produto*/
    INTO total
    FROM produto
